...
import {TextField, FormControl, InputLabel,Select, MenuItem, Chip, Input, FormHelperText} from '@material-ui/core';
    ...
    return(
        <OutlinedDiv label={"Estabelecimento"} className={classes.outlinedDiv}>
          <div className={classes.restaurantDiv}>
            ...
            <FormControl className={[classes.formControl, classes.selectControl].join(" ")}>
                <InputLabel id="options-tags-label">Opções do Estabelecimento</InputLabel>
                <Select
