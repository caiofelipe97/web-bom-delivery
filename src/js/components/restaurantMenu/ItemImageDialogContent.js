...
class ItemImageDialogContent extends PureComponent {
  ...
  render() {
    ...
    const { classes, handleSelectImage, handleImgDialogClose } = this.props;
    return (
        <DialogContent>
...
<ReactCrop
    ...
    <div className={classes.buttons}>
        <Button onClick={()=>handleSelectImage(croppedImageUrl)} variant="contained"  color="secondary" type="submit">Selecionar</Button>
...
export default withStyles(styles)(ItemImageDialogContent);